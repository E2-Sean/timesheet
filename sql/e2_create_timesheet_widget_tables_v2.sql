...
insert into client (client_name, active) values ('Engine No.2','T');
insert into client (client_name, active) values ('Child Cancer Foundation NZ','T');
insert into client (client_name, active) values ('All About Caring','T');
